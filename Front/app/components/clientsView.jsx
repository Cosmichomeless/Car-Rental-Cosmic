    ...
    const fetchData = async () => {
        try {
            ...
            const formattedData = clientes.map(cliente => ({
                ...
                subtitle: `Email: ${cliente.email}, Teléfono: ${cliente.telefono}`,
                ...cliente
            }));
                ...
                <Modal animationType="fade" transparent={true} visible={modalVisible}>
                    <View style={styles.overlay}>
                        <View style={styles.modalcontainer}>
                            ...
                            <Text style={styles.modalText}>Nombre: {selectedItem.nombre}</Text>
                            <Text style={styles.modalText}>Apellido: {selectedItem.apellido}</Text>
